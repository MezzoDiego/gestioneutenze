...
public class UtenteDTO {
	...
	public UtenteDTO(Long id, String username, String nome, String cognome, LocalDate dataDiNascita) {
		super();
		this.id = id;
	...
	public Utente buildUtenteModel(boolean includeIdRole) {
		Utente result = new Utente(this.id, this.username, this.password, this.nome, this.cognome, this.dataDiNascita);
